...
def get_help_text():
    ...
    help_text = [
        ...
        f"  {click.style('jayrah browse [BOARD] TERM1 TERM2', fg='cyan')}    {click.style('Search for issues matching TERM1 AND TERM2', fg='white')}",
        f"  {click.style('jayrah browse [BOARD] --or TERM1 TERM2', fg='cyan')}    {click.style('Search for issues matching TERM1 OR TERM2', fg='white')}",
        f"  {click.style('jayrah git-branch', fg='cyan')}    {click.style('Suggest a git branch name based on your issues', fg='white')}",
        f"  {click.style('jayrah git-branch TERM1 TERM2', fg='cyan')}    {click.style('Search your issues with AND logic and create branch', fg='white')}",
        f"  {click.style('jayrah git-branch --or TERM1 TERM2', fg='cyan')}    {click.style('Search your issues with OR logic and create branch', fg='white')}",
