...
2026-02-22 00:00 UTC | claude | filter-search-ux | Added blinking cursor in filter/search bars using frame.set_cursor_position(); cursor appears at text insertion point when filter_mode or search_mode is active, clamped to bar bounds | complete | none
2026-02-22 00:00 UTC | claude | remaining-todos-uncertainties | Updated current state after blinking cursor addition | none | none
2026-02-21 20:14 UTC | codex | phase3-edit-popup-render | Started fixing distorted edit-input description popup rendering in Rust TUI | in_progress | Isolate popup draw path from edit-input overlay and add regression test coverage
2026-02-21 20:14 UTC | codex | phase3-edit-popup-render | Prevented double-popup rendering during edit input by skipping generic popup draw when edit overlay is active; replaced full main-area clear with targeted edit-popup clear and input-section clears | complete | Run rust fmt and jayrah-tui tests
2026-02-21 20:14 UTC | codex | phase3-edit-popup-render | Verified with `cargo fmt --all` and `cargo test -p jayrah-tui` (138 passed) including new overlay regression test | complete | Remaining TODOs / uncertainties update
2026-02-21 20:14 UTC | codex | remaining-todos-uncertainties | Updated current state after edit-input popup render isolation and cleanup | none | none
2026-02-21 20:16 UTC | codex | phase3-edit-popup-render | Added second-pass hardening for edit description rendering by normalizing CRLF/carriage-return seed text before textarea render | complete | Add regression tests in app and tui modules
2026-02-21 20:16 UTC | codex | phase3-edit-popup-render | Added regression tests for edit-input overlay visibility and CRLF normalization (`app` + `tui`) and re-verified full crate suite | complete | Remaining TODOs / uncertainties update
2026-02-21 20:16 UTC | codex | remaining-todos-uncertainties | Updated current state after CRLF normalization hardening for edit input | none | none
